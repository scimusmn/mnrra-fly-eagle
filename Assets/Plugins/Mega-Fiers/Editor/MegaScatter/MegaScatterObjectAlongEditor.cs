...
[CustomEditor(typeof(MegaScatterObjectAlong))]
public class MegaScatterObjectAlongEditor : Editor
{
	private     MegaScatterObjectAlong	src;
	private     MegaUndo			undoManager;

	[MenuItem("GameObject/Create Other/MegaScatter/Scatter Object Along")]
	static void CreateScatterObjectAlong()
	{
		...
		GameObject go = new GameObject("Scatter Obj Along");

		go.AddComponent<MegaScatterObjectAlong>();
	...
	{
		src = target as MegaScatterObjectAlong;

		undoManager = new MegaUndo(src, "Mega Scatter Object Along Param");
	}
	...
	{
		MegaScatterObjectAlong mod = (MegaScatterObjectAlong)target;
